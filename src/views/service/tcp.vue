  ...
  methods: {
    fetchData (id) {
      ...
      serviceDetail(query).then(response => {
        ...
        this.form.status = formData.info.status
        ...
        this.form.open_auth = formData.access_control.open_auth
        this.form.open_black_list = formData.access_control.open_black_list
        this.form.open_white_list = formData.access_control.open_white_list
        ...
        this.form.round_type = formData.load_balance.round_type
    ...
    onSubmit () {
      ...
      formData.open_black_list = Number(formData.open_black_list)
      formData.open_white_list = Number(formData.open_white_list)
