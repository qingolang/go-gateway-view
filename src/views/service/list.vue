<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.info"
    ...
    <el-table :key="tableKey"
      ...
      <el-table-column label="操作"
        ...
        <template slot-scope="{row,$index}">
          ...
          <router-link v-if="row.load_type===0"
          ...
          <router-link v-if="row.load_type===1"
          ...
          <router-link v-if="row.load_type===2"
